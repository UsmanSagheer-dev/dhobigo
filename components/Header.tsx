...
export default function Header() {
    return (
        <header style={{padding:16, borderBottom:'1px solid var(--color-border)', backgroundColor:'var(--color-foreground)', display:'flex', justifyContent:'flex-end', alignItems:'center'}}>
