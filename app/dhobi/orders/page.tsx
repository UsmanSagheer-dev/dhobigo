...
export default function Orders() {
  return (
    <div className='p-5 flex flex-col gap-2'>
      <h1>Active Orders</h1>
      <h1 className='text-[var(--textSecondary)] dark:text-[var(--textSecondary)] '>فعال آرڈرز</h1>
      ...
      <div className='bg-[var(--foreground)] flex flex-col gap-2  items-center justify-center h-60 rounded-lg mt-3 dark:bg-[var(--foreground)] '>
        <h1 className='text-[var(--textSecondary)] dark:text-[var(--textSecondary)]'>No active orders</h1>
        <h1 className='text-[var(--textSecondary)] dark:text-[var(--textSecondary)]'>کوئی فعال آرڈر نہیں</h1>
        <p className='text-[var(--textSecondary)] dark:text-[var(--textSecondary)]'>Go online to start receiving orders</p>
      </div>
