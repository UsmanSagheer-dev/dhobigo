...
export default function DhobiPortal() {
  ...
  return (
    <div className=' flex text-black flex-col bg-indigo-50 p-5  dark:bg-gray-950 dark:text-white '>
      <h1  >Dashboard </h1>
      <h1 className='  font-bold '>ڈیش بورڈ </h1>
      ...
      <div className='mt-5 p-5 bg-white dark:bg-slate-900 rounded-lg'>
